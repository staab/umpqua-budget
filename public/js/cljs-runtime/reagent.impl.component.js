...
if((i < len)){
var k = (ks[i]);
var G__35837 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35838 = (i + (1));
m = G__35837;
i = G__35838;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35792 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__35792);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35794 = c;
var G__35794__$1 = (((G__35794 == null))?null:G__35794.prototype);
if((G__35794__$1 == null)){
return null;
} else {
return (G__35794__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35798 = c;
var G__35798__$1 = (((G__35798 == null))?null:G__35798.prototype);
if((G__35798__$1 == null)){
return null;
} else {
return (G__35798__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__35861__delegate = function (args){
var G__35800 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35800) : reagent.impl.component.as_element.call(null,G__35800));
};
...
while (G__35862__i < G__35862__a.length) {G__35862__a[G__35862__i] = arguments[G__35862__i + 0]; ++G__35862__i;}
  args = new cljs.core.IndexedSeq(G__35862__a,0,null);
} 
return G__35861__delegate.call(this,args);};
G__35861.cljs$lang$maxFixedArity = 0;
G__35861.cljs$lang$applyTo = (function (arglist__35863){
var args = cljs.core.seq(arglist__35863);
return G__35861__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__35801 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35802 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35802;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35801;
}});
...
return ((function (G__35803,G__35803__$1){
...
var c = this;
var G__35814_35878 = (c["cljsRatom"]);
if((G__35814_35878 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35814_35878);
}
...
var renders_35889 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_35890 = cljs.core.first(cljs.core.vals(renders_35889));
if((cljs.core.count(renders_35889) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35889))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35890)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35890], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35815 = name;
switch (G__35815) {
case "":
...
var G__35817 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__35817);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35818 = fiber;
var G__35818__$1 = (((G__35818 == null))?null:(G__35818["type"]));
if((G__35818__$1 == null)){
return null;
} else {
return (G__35818__$1["displayName"]);
}
})();
var parent = (function (){var G__35819 = fiber;
if((G__35819 == null)){
return null;
} else {
return (G__35819["return"]);
}
})();
var path = (function (){var G__35820 = parent;
var G__35820__$1 = (((G__35820 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35820) : reagent.impl.component.fiber_component_path.call(null,G__35820)));
if((G__35820__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35820__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__35822 = c;
if((G__35822 == null)){
return null;
} else {
return (G__35822["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35823._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__35825 = c;
if((G__35825 == null)){
return null;
} else {
return (G__35825["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__35827 = c;
if((G__35827 == null)){
return null;
} else {
return G__35827._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__35829 = instance;
if((G__35829 == null)){
return null;
} else {
return (G__35829["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__35830 = instance;
if((G__35830 == null)){
return null;
} else {
return G__35830._currentElement;
}
}
})();
var name = (function (){var G__35831 = elem;
var G__35831__$1 = (((G__35831 == null))?null:(G__35831["type"]));
if((G__35831__$1 == null)){
return null;
} else {
return (G__35831__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__35833 = elem;
if((G__35833 == null)){
return null;
} else {
return (G__35833["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35834._owner;
}
}
})();
var path = (function (){var G__35835 = owner;
var G__35835__$1 = (((G__35835 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35835) : reagent.impl.component.component_path.call(null,G__35835)));
if((G__35835__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35835__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35836 = c;
var G__35836__$1 = (((G__35836 == null))?null:G__35836.constructor);
if((G__35836__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35836__$1);
}
}
})();
