...
return cljs.core.deref(wedge.client.ws.ws).send(p1__36011_SHARP_);
});})(all_messages))
,all_messages);
...
var hierarchy__4617__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__36012 = cljs.core.get_global_hierarchy;
return (fexpr__36012.cljs$core$IFn$_invoke$arity$0 ? fexpr__36012.cljs$core$IFn$_invoke$arity$0() : fexpr__36012.call(null));
})());
...
var G__36013 = cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(evt.data);
return (wedge.client.ws.handle_message.cljs$core$IFn$_invoke$arity$1 ? wedge.client.ws.handle_message.cljs$core$IFn$_invoke$arity$1(G__36013) : wedge.client.ws.handle_message.call(null,G__36013));
});
wedge.client.ws.start_ws_BANG_ = (function wedge$client$ws$start_ws_BANG_(){
var temp__5720__auto___36019 = cljs.core.deref(wedge.client.ws.ws);
if(cljs.core.truth_(temp__5720__auto___36019)){
var old_ws_36021 = temp__5720__auto___36019;
old_ws_36021.close();
} else {
}
