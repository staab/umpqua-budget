...
return cljs.core.deref(wedge.client.ws.ws).send(p1__27225_SHARP_);
});})(all_messages))
,all_messages);
...
var hierarchy__4617__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__27226 = cljs.core.get_global_hierarchy;
return (fexpr__27226.cljs$core$IFn$_invoke$arity$0 ? fexpr__27226.cljs$core$IFn$_invoke$arity$0() : fexpr__27226.call(null));
})());
...
wedge.client.ws.ws_interval = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
...
var G__27227 = cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(evt.data);
return (wedge.client.ws.handle_message.cljs$core$IFn$_invoke$arity$1 ? wedge.client.ws.handle_message.cljs$core$IFn$_invoke$arity$1(G__27227) : wedge.client.ws.handle_message.call(null,G__27227));
});
wedge.client.ws.start_ws_BANG_ = (function wedge$client$ws$start_ws_BANG_(f){
var temp__5720__auto___27230 = cljs.core.deref(wedge.client.ws.ws);
if(cljs.core.truth_(temp__5720__auto___27230)){
var old_ws_27231 = temp__5720__auto___27230;
old_ws_27231.close();
} else {
}

clearInterval(cljs.core.deref(wedge.client.ws.ws_interval));

cljs.core.reset_BANG_(wedge.client.ws.ws_interval,setInterval((function (){
if((cljs.core.deref(wedge.client.ws.ws) == null)){
return (wedge.client.ws.start_ws_BANG_.cljs$core$IFn$_invoke$arity$1 ? wedge.client.ws.start_ws_BANG_.cljs$core$IFn$_invoke$arity$1(cljs.core.identity) : wedge.client.ws.start_ws_BANG_.call(null,cljs.core.identity));
} else {
return null;
}
}),(1000)));
...
socket.addEventListener("error",((function (socket){
return (function (){
